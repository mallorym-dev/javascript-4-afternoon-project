...
class ProgressiveManager extends Manager {
  ...
  hire() {
    super.hire()
    const newReport = this.reports.length
    if (newReport === 0) {
      this.title = ('Not a Manager')
    } else if (newReport >= 1 && newReport <= 3) {
      this.title = ('Barely Manager')
    } else if (newReport >= 4 && newReport <= 10) {
      this.title = ('Mostly Manager')
    } else if (newReport >= 11 && newReport <= 50) {
      this.title = ('Manager')
    } else if (newReport >= 51 && newReport <= 100) {
